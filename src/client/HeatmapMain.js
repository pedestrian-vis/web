...
class HeatmapMain extends React.Component {
  constructor(props) {
    super(props);
  }
  ...
  render() {
    ...
    const hot2 = 'rgb(255, 255, 255)';
    const data = JSON.parse(this.getJSON(this.props.utilization_url));
...
export default connect(mapStateToProps, mapDispatchToProps)(HeatmapMain);